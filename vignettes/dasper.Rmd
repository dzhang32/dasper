...
Often regions of splicing can be complex within a gene and you may want to consider zooming in on a specific region of interest. 
...
plot_sashimi(junctions_normed,
    ...
    control_agg_func = mean,
    gene_tx_id = gene_id, 
    region = GenomicRanges::GRanges("chr22:41605000-41610000")
