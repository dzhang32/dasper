...
```{r, "seqlevels to match bw"}
GenomeInfoDb::seqlevels(junctions_example) <-
    paste0("chr", GenomeInfoDb::seqlevels(junctions_example))

GenomeInfoDb::seqlevels(ref) <-
    paste0("chr", GenomeInfoDb::seqlevels(ref))
```
